...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://hiteshgml-8000.theiadockernext-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai',  # ✅ Add this
]
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # Added if missing
